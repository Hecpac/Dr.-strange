...
- No lanzar Chrome con scripts puente. El perfil administrado es `~/.claw/chrome-profile`.
- Google login activo en el perfil administrado.
...
- En Claw el puerto CDP canonico es 9250. No usar 9222 salvo override explicito de `CLAW_CHROME_PORT`.
