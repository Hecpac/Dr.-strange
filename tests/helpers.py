...
def make_config(root: Path) -> AppConfig:
    config = AppConfig(
        ...
        worker_heavy_provider="codex",
        worker_heavy_model="gpt-5.5",
        ...
        tier_autoexec_max=2,
        observability_telegram_chat_id=None,
        observation_cost_per_hour_threshold=1.50,
        observation_tool_calls_per_minute_threshold=10,
        token_window_seconds=18_000,
        token_window_cap=1_000_000,
        token_soft_limit_ratio=0.8,
        token_hard_limit_ratio=1.0,
        command_isolation_mode="host_sanitized",
        enable_trivial_automerge=False,
        chrome_cdp_enabled=False,
        claw_chrome_port=9250,
        notebooklm_backend="cdp",
        notebooklm_cli_path="nlm",
        notebooklm_cli_profile=None,
